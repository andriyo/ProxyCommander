...
class ProxyCommanderControllerTest {
    ...
    fun connectDevice_failsWhenReverseCannotBeEnabled() {
        ...
        // The proxy setting is still applied; only the overall result reports the failure.
        assertEquals("localhost:8888", adb.globalSetting("emulator-5554", "http_proxy"))
    ...
    private class FakeAdb(vararg serials: String) : AdbCommander {
        ...
        override fun checkAvailability(): AdbCommandResult =
            AdbCommandResult(0, "Android Debug Bridge version 1.0.41", listOf("adb", "version"))
        ...
        override fun run(
            ...
            return when {
                ...
                args == listOf("devices") -> ok(args, buildString {
